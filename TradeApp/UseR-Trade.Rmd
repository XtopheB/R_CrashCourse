...
resource_files:
- www/SITCCodeandDescription.xlsx
- www/IMTS Correspondence.xlsx
---
...
HS_SITC_concordance     <- read_excel("./www/IMTS Correspondence.xlsx", sheet = "HS SITC BEC") %>%
  rename(HS_Code = `HS22`, SITC_Code = SITC4) %>%
  mutate(HS_Code = as.character(HS_Code), SITC_Code = as.character(SITC_Code))

SITC_description        <- read_excel("./www/SITCCodeandDescription.xlsx", sheet = "SITC4") %>%
