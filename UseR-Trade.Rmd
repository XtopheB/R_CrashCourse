...
![](www/tidy-group_by.png){width=50%}
...
![](www/tidy-group_by_summarize.png){width=60%}
...
![](www/tidy-pivot_wider1.png){width=40%}
And finally get all 6 values in  `df_w` 

![](www/tidy-pivot_wider2.png){width=40%}
