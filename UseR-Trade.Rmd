...
>  **Your goal**: Build a *horizontal bar chart* showing exports and imports for the **top 10 partner countries**.

**Hints:**

- First, in `table2`,  keep only the top 10 countries by export value (use `slice()` after a wise ordering)
...
- Start by keeping the 10 largest exports from table3
...
ggplot(table3_long,
  ...
  geom_col(position = position_dodge(width = 0.9)) +
  coord_flip() +
  labs(title = "Trade flows by top 10 exported commodities  (million USD)",
       x = "Product", y = "Value (million USD)", fill = "Trade flow") +
