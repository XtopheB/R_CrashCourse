...
```{r Idmatrix,  exercise = TRUE, exercise.eval = FALSE}
# Enter your solution below
...
One can add matrices of the same dimensions, simply by using ` + `
...
Vectors are one-dimensional matrices. Here's how to create one:
```{r}
