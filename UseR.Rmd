...
SDG_16.1.3 <- envipe2019_clean  %>%
  ...
  filter(AP7_3_11 ==1) %>%
  summarize( Indicator = 100* sum(Weight / WeightedPop)) 
...
$$
SDG\_16.1.3  =  \frac{\sum_i 1_{[Victim_i==1]} \times weight_i }{\sum_i weight_i} \times 100 = \sum_i \frac{ 1_{[Victim_i==1]} \times weight_i }{\sum_i weight_i} \times 100 \\
Or:   \; 

SDG\_16.1.3  = \sum_{Victim_i} \frac{  weight_i }{\sum_i weight_i} \times 100 =  \sum_{Victim_i} \frac{  weight_i }{WeightedPop} \times 100\\
