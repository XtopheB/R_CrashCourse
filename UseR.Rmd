...
quiz(
  question("In the *envipe2019*, are all variables encoded as **character**? (look above,  after *@ format.spss*)",
    ...
    answer("Yes, but this is correct", correct = FALSE, message = " - Having variables that are numerical encoded as characters will cause a lot of problem, since some operations will not work correctly on a character variable"),
