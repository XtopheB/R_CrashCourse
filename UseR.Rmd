...
The variable we need include (names are in Spanish): 
...
In the next code chunk, we create a new data frame - called envipe2019 - with only those variables. We use for that the function `select()`. 
