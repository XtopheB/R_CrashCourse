...
In R, square brackets have a special function for accessing or extracting values from objects, which is essential for data manipulation. The value(s) in the square brackets are called the **index**, which indicate the position of the elements to be extracted.  For dataframes, the convention is raw first, then column:  `mydata[indexraw, indexcolumn']
