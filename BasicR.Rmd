...
The second line creates a new data frame called *MyTest2* that stores the data from the SPSS data file called "*testdata.sav*".^[There are other packages available for importing data sets from other software, such a the popular *foreign* package. However, *haven* is recommended for its integration into the  *tidyverse* environment.]  
